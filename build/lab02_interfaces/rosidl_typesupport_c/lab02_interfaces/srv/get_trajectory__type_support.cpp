...
static const _GetTrajectory_Request_type_support_symbol_names_t _GetTrajectory_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lab02_interfaces, srv, GetTrajectory_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, lab02_interfaces, srv, GetTrajectory_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, lab02_interfaces, srv, GetTrajectory_Request)() {
  return &::lab02_interfaces::srv::rosidl_typesupport_c::GetTrajectory_Request_message_type_support_handle;
}
...
static const _GetTrajectory_Response_type_support_symbol_names_t _GetTrajectory_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lab02_interfaces, srv, GetTrajectory_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, lab02_interfaces, srv, GetTrajectory_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, lab02_interfaces, srv, GetTrajectory_Response)() {
  return &::lab02_interfaces::srv::rosidl_typesupport_c::GetTrajectory_Response_message_type_support_handle;
}
...
static const _GetTrajectory_type_support_symbol_names_t _GetTrajectory_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lab02_interfaces, srv, GetTrajectory)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, lab02_interfaces, srv, GetTrajectory)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, lab02_interfaces, srv, GetTrajectory)() {
  return &::lab02_interfaces::srv::rosidl_typesupport_c::GetTrajectory_service_type_support_handle;
}
