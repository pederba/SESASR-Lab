...
class RecorderNode(Node):
    ...
    def store_data(self, odom, filter, ground_truth):
        ...
        self.odom.append([odom.pose.pose.orientation.x, odom.pose.pose.orientation.y, yaw])  # Insert the data that you want to save in the lists
        ...
        self.filter.append([filter.pose.pose.orientation.x, filter.pose.pose.orientation.y, yaw]) # Insert the data that you want to save in the lists
        
        _, _, yaw = tf_transformations.euler_from_quaternion([ground_truth.pose.pose.orientation.x, ground_truth.pose.pose.orientation.y, ground_truth.pose.pose.orientation.z, ground_truth.pose.pose.orientation.w])
        self.ground_truth.append([ground_truth.pose.pose.orientation.x, ground_truth.pose.pose.orientation.y, yaw]) # Insert the data that you want to save in the lists
